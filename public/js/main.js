    ...
    function zikaDetails() {
        ...
        if (orig_zika.travel !== null && dest_zika.travel !== null) {
            ...
            if (risk_percent >= 0 && risk_percent < 0.26) {
                ...
                risk_msg = risk_msg + "<div class=\"progress\"> <div class=\"progress-bar progress-bar-striped green\" role=\"progressbar\" aria-valuenow=\"" + risk_num + "\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"min-width:30%\">LOW</div></div>";
            } else if (risk_percent >= 0.26 && risk_percent < 0.51) {
                //risk_msg = risk_msg + "<span class='yellow'>SOMEWHAT LOW</span>.";
                risk_msg = risk_msg + "<div class=\"progress\"> <div class=\"progress-bar progress-bar-striped yellow\" role=\"progressbar\" aria-valuenow=\"" + risk_num + "\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"min-width:80%\">SOMEWHAT LOW</div></div>";
            } else if (risk_percent >= 0.51 && risk_percent <= 1) {
                //risk_msg = risk_msg + "<span class='red'>SOMEWHAT HIGH</span>.";
                risk_msg = risk_msg + "<div class=\"progress\"> <div class=\"progress-bar progress-bar-striped red\" role=\"progressbar\" aria-valuenow=\"" + risk_num + "\" aria-valuemin=\"0\" aria-valuemax=\"100\" style=\"min-width:92%\">SOMEWHAT HIGH</div></div>";
            }
            if (risk_msg) {
